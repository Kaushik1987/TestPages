...
{  
  clickedObject = eval('mItem' + NodeID);
	...
	if (clickedObject && clickedObject.IsShow)
	{
	  ...
	  {
	    eval('document.all.Proj' + SelNodeID + '.children[0].style.backgroundColor = ""');
	    eval('document.all.Proj' + SelNodeID + '.all["JobTitle"].style.color = ""');
	    eval('document.all.Proj' + SelNodeID + '.all["arrowLeft"].style.visibility = "hidden"');
	    eval('document.all.Proj' + SelNodeID + '.all["arrowRight"].style.visibility = "hidden"');
	  }
    ...
    else
    {
	  ...
	  try 
	  {
	    ...
	    if (highlightColor == 2 || highlightColor == 3)
		{
	      ...
	      eval('document.all.Proj' + NodeID + '.all["JobTitle"].style.color = "white"');
	      eval('document.all.Proj' + NodeID + '.all["arrowLeft"].style.visibility = ""');
	      eval('document.all.Proj' + NodeID + '.all["arrowRight"].style.visibility = ""');
		}
	  ...
	  {
		SelNodeID = 0;
		document.all.Proj0.style.display = "inline"; 
...
function showJob(NodeID)
{
  ...
  eval('document.all.Proj' + NodeID + '.style.display = "inline"');  
  eval('document.all.ProjDtl' + NodeID + '.style.display = "inline"');
...
{
  var allTime = document.getElementsByName('timeRow');
